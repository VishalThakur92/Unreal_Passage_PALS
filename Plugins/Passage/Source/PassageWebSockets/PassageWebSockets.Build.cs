...
public class PassageWebSockets : ModuleRules
{
	...
	protected virtual bool bPlatformSupportsWinHttpWebSockets
	{
		get
		{
			// Availability requires Windows 8.1 or greater, as this is the min version of WinHttp that supports PassageWebSockets
	...
	public PassageWebSockets(ReadOnlyTargetRules Target) : base(Target)
	{
