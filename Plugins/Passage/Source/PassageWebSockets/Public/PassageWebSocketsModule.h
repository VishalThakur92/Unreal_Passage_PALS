 ...
 */
class PASSAGEWEBSOCKETS_API FPassageWebSocketsModule :
	public IModuleInterface
{

public:

	// FPassageWebSocketModule
	 ...
	 */
	static FPassageWebSocketsModule& Get();
...
private:
	...
	friend class FPassageLwsWebSocketsManager;
	friend class FPassageLwsWebSocket;
#endif // #if WITH_WEBSOCKETS

	/** singleton for the module while loaded and available */
	static FPassageWebSocketsModule* Singleton;
};
